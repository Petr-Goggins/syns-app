...
Контакт для вопросов и коммерческого использования: petr.sync@mail.ru

1. Данное программное обеспечение (далее — ПО) предоставляется в исходном коде для ознакомления, изучения и личного некоммерческого использования.

2. Вы имеете право:
   - использовать ПО в личных, образовательных и некоммерческих целях;
   - изменять и дорабатывать ПО для собственных нужд;
   - распространять ПО в неизменном виде при условии сохранения данной лицензии и указания авторства.

3. Запрещается:
   - использовать ПО в коммерческих целях (включая, но не ограничиваясь: продажа, аренда, субаренда, использование в коммерческих продуктах, услугах или стартапах) без письменного разрешения автора;
   - удалять или изменять уведомления об авторских правах;
   - выдавать чужой код за свой.

4. Для получения коммерческой лицензии или по любым вопросам обращайтесь по адресу: petr.sync@mail.ru

ПО ПРЕДОСТАВЛЯЕТСЯ «КАК ЕСТЬ», БЕЗ КАКИХ-ЛИБО ГАРАНТИЙ. АВТОР НЕ НЕСЁТ ОТВЕТСТВЕННОСТИ ЗА ЛЮБЫЕ УБЫТКИ, ВОЗНИКШИЕ В РЕЗУЛЬТАТЕ ИСПОЛЬЗОВАНИЯ ДАННОГО ПО.

© 2026 Petr Goggins. Все права защищены.
