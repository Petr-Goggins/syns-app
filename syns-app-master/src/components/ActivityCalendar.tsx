...
export default function ActivityCalendar({
  ...
  const getColorClass = (day: ActivityDay) => {
    ...
    return 'bg-accent-green/20'; // Light green
  };
        ...
        {calendarDays.map((day) => (
          ...
          >
            {showTooltip && hoveredDay === day.date && day.hasWorkout && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-bg-secondary border border-border rounded text-xs text-text whitespace-nowrap z-10 shadow-lg">
